...
db_init -lib_path $PROJ_PATH/lib/nangate/lib/merged.lib
db_init -sdc_path $SDC_FILE
tech_lef_init -path $PROJ_PATH/lib/nangate/lef/NangateOpenCellLibrary.tech.lef
lef_init -path $PROJ_PATH/lib/nangate/lef/NangateOpenCellLibrary.macro.mod.lef

verilog_init -path $NETLIST_V -top $DESIGN
run_no_fixfanout -config $PROJ_PATH/script/fix-fanout.json
